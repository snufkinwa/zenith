...
export const useCanvasEvents = ({
  ...
  const handleMouseDown = useCallback((e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    canvasRef, currentTool, elements, setSelectedElement, 
    startDrawing, startDragging, showTextInputAt
  ]);
  ...
  const handleMouseMove = useCallback((e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    isDrawing, startPoint, canvasRef, currentTool, selectedElement, 
    dragOffset, currentColor, currentFillColor, strokeWidth,
    updateElement, updatePreview
  ]);
  ...
  const handleMouseUp = useCallback((e: React.MouseEvent<HTMLCanvasElement>) => {
    ...
    if (currentTool !== 'select') {
      ...
      const isLargeEnough = 
        ...
        (newElement.endX && Math.abs(newElement.endX - newElement.x) > MIN_ELEMENT_SIZE);
    ...
    isDrawing, currentTool, selectedElement, dragOffset, startPoint,
    elements, currentColor, currentFillColor, strokeWidth,
    canvasRef, saveToHistory, stopDragging, addElement, stopDrawing
  ]);
